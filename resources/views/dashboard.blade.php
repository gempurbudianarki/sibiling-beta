<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- Salam Pembuka (untuk semua user) --}}
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    ...
                    @else
                        <p class="mt-1 text-sm text-gray-600">Anda telah berhasil login ke sistem SIBILING.</p>
                    @endif
                </div>
            </div>

            {{-- ====================================================== --}}
            {{-- ==== TAMPILKAN BLOK STATISTIK HANYA UNTUK ADMIN ==== --}}
            {{-- ====================================================== --}}
            @if($is_admin)
            ...
            @endif
            {{-- ====================================================== --}}
            {{-- ==== AKHIR DARI BLOK STATISTIK ADMIN ==== --}}
            {{-- ====================================================== --}}
        </div>
    </div>
</x-app-layout>